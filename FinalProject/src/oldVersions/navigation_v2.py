...
def pathingPhase(totalDistTravelled):
    ...
    distToTunnel = 0.6 # distance travelled by robot before tunnel (UNDERESTIMATE)
    distPastTunnel = 1.2 # distance travelled by robot after clearing tunnel (OVERESTIMATE)
